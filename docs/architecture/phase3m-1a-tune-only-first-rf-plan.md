...
| # | Task | Tests | Cite |
|---|---|---|---|
| B.1 | `PttSource` enum (9 values: NONE, MANUAL, MIC, CW, CAT, VOX, SPACE, X2, TCI) + helpers (`pttSourceLabel(PttSource)`, `pttSourceFromString(QString)`) | `tst_ptt_source.cpp` (already exists from 3M-0; extend if needed) | Pre-code §1.5 + Thetis `enums.cs:346-359` |

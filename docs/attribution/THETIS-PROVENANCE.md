...
| src/gui/meters/presets/BarPresetItem.cpp | Project Files/Source/Console/MeterManager.cs | 23326-23533 | port | thetis-samphire | AddALCBar/AddALCGainBar/AddALCGroupBar min/max/threshold constants for Alc/AlcGain/AlcGroup flavours; 15 further flavours collapse NereusSDR ItemGroup::create*BarPreset() factories |
| src/gui/meters/presets/BarPresetItem.h | Project Files/Source/Console/MeterManager.cs | 23326-23533 | port | thetis-samphire | parameterised 18-flavour bar row; pairs with BarPresetItem.cpp |
...
| src/gui/meters/presets/SMeterPresetItem.cpp | Project Files/Source/Console/MeterManager.cs | 21499-21616 | port | thetis-samphire | AddSMeterBarSignal/addSMeterBar 3-point non-linear calibration port; collapses createSMeterPreset + createSMeterBarPreset |
...
| src/gui/meters/presets/SignalTextPresetItem.cpp | Project Files/Source/Console/MeterManager.cs | 21678-21740 | port | thetis-samphire | AddSMeterBarText backdrop + signal-text composition port |
| src/gui/meters/presets/SignalTextPresetItem.h | Project Files/Source/Console/MeterManager.cs | 21678-21740 | port | thetis-samphire | first-class large signal readout; pairs with SignalTextPresetItem.cpp |
